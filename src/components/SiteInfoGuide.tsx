          ...
          <div id="site-info-guide-body" className="site-info-guide-body">
            ...
            {activeTab === 'query' && (
              <div className="site-info-guide-panel">
                <div>
                  <h3>查詢時先看什麼？</h3>
                  <p>輸入歌名或歌手，找到歌曲後，分別查看 KTV 收錄、導唱與 MV 資訊。</p>
                </div>
                <div>
                  <h3>去 KTV 前怎麼準備？</h3>
                  <p>先列出想唱歌曲，用 TYFunLab 查收錄、導唱與 MV 類型，再把想唱的歌加入我的歌本，比較各平台的收錄線索並複製文字摘要。到現場後，仍以包廂內點歌系統再次確認。</p>
                </div>
                <div>
                  <h3>找不到歌怎麼辦？</h3>
            ...
            {activeTab === 'data' && (
              <div className="site-info-guide-panel">
                ...
                <div>
                  <h3>為什麼需要回報？</h3>
                  <p>KTV 現場會受門市、機台、曲庫更新與平台差異影響。當歌友回報「有」多於「沒有」時，列表會用同一組標籤補上可參考狀態。</p>
                </div>
                <div>
                  <h3>資料可信度怎麼看？</h3>
                  <p>把查詢結果視為出發前參考最合適。社群回報能提高可見度，但若資訊牽涉是否能點唱、是否有導唱或畫面類型，仍請以現場點歌系統為準。</p>
                </div>
                <div>
                  <h3>為什麼不用單一答案？</h3>
            ...
            {activeTab === 'media' && (
              <div className="site-info-guide-panel">
                <div>
                  ...
                  <p>「有收錄」表示網站資料或歌友回報顯示該平台有這首歌。導唱和 MV 要分開查看；「尚未確認」不代表沒有。實際情況請以現場為準。</p>
                </div>
                <div>
                  <h3>MV 標示怎麼看？</h3>
                  <p>MV 類型標示用來區分現場畫面可能接近原版 MV、伴唱帶類型或其他版本。它可能來自原始資料或歌友投票，不是品質評分，也不代表所有門市一致。</p>
                </div>
                <div>
                  <h3>平台差異會影響什麼？</h3>
