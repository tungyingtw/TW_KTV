...
export const SongDetailModal: React.FC<SongDetailModalProps> = ({
  ...
  return (
    <>
      ...
      >
        {/* 外層容器：設定 borderRadius + overflow:hidden，防止滾軸穿出圓角 */}
        <div
        ...
        <div
          ...
          style={{
            ...
            padding: '24px',
            position: 'relative',
            borderRadius: 0, /* 由外層容器負責圓角 */
            border: 'none', /* 由外層容器負責邊框 */
            boxShadow: 'none', /* 由外層容器負責陰影 */
          }}
        >
          {/* Close Button */}
          <button
          ...
          {/* Lyrics Snippet (僅顯示真實經典歌詞，無歌詞時呈現歡唱導引) */}
          {song.lyricsSnippet && !song.lyricsSnippet.includes('全台 10 大 KTV') ? (
            ...
            <div style={{
              ...
              <span style={{ fontSize: '0.78rem', color: '#a855f7', fontWeight: 600 }}>[自動即時對照]</span>
            </div>
          )}
          ...
          <h4 style={{
            ...
            <Sparkles size={16} color="var(--accent-pink)" /> 全台 10 大 KTV 廠牌收錄狀態：
          </h4>
