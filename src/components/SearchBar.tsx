        ...
        <div className="search-filter-strip">
          ...
          <div className="search-bar-bottom-row" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '10px', flexWrap: 'wrap', width: '100%' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
              <label className={`quality-filter-chip is-mv ${filters.onlyOfficialMv ? 'is-selected' : ''}`} title="只看目前有原版 MV 線索的歌曲。" style={{
                display: 'flex',
                alignItems: 'center',
                gap: '5px',
                fontSize: '0.82rem',
              ...
              <label className={`quality-filter-chip is-guided ${filters.onlyGuidedVocal ? 'is-selected' : ''}`} title="只看目前有導唱線索的歌曲。" style={{
                display: 'flex',
                alignItems: 'center',
                gap: '5px',
                fontSize: '0.82rem',
