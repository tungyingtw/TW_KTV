...
const KEY_NAME = 'full_catalog_v19';
...
export async function getCachedCatalog(): Promise<Song[] | null> {
  try {
    ...
    ['full_catalog_v1', 'full_catalog_v2', 'full_catalog_v3', 'full_catalog_v4', 'full_catalog_v5', 'full_catalog_v6', 'full_catalog_v7', 'full_catalog_v8', 'full_catalog_v9', 'full_catalog_v17', 'full_catalog_v18'].forEach(k => storeClear.delete(k));
...
const TIME_KEY = 'full_catalog_timestamp_v19';
